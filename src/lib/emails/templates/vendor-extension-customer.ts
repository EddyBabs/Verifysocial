...
export const VendorExtensionCustomerTemplate = `
                      ...
                      <tbody>
                        <tr>
                          ...
                          >
                            ...
                            <p>
                              We are sorry to inform you that the {{vendorName}} with ID {{orderNumber}} has extended the delivery of your goods with the stated reason {{extendedReason}}
                            </p>
                            <p>
                              We understand how this makes you feel, we are committed to ensuring that this is delivered on {{extendedData}}.
                            </p>
